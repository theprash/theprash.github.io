...
{{
var G__18491 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18491;
continue;
}
} else
...
{var pred__18495 = cljs.core._EQ_;var expr__18496 = limit;if(cljs.core.truth_(pred__18495.call(null,1,expr__18496)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18495.call(null,2,expr__18496)))
...
var G__18498 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18499 = (limit__$1 - 1);
var G__18500 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18498;
limit__$1 = G__18499;
parts = G__18500;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___18502 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___18502))
{var replacement_18503 = temp__4090__auto___18502;buffer.append([cljs.core.str(replacement_18503)].join(''));
} else
{buffer.append(ch);
}
{
var G__18504 = (index + 1);
index = G__18504;
continue;
}
}
