...
{{
var G__10504 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10504;
continue;
}
} else
...
{var pred__10508 = cljs.core._EQ_;var expr__10509 = limit;if(cljs.core.truth_(pred__10508.call(null,(1),expr__10509)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10508.call(null,(2),expr__10509)))
...
var G__10511 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10512 = (limit__$1 - (1));
var G__10513 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10511;
limit__$1 = G__10512;
parts = G__10513;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10515 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10515))
{var replacement_10516 = temp__4124__auto___10515;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10516)));
} else
{buffer.append(ch);
}
{
var G__10517 = (index + (1));
index = G__10517;
continue;
}
}
