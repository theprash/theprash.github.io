...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14856 = (0);while(true){
var m_14857 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14857 == null))
{} else
{m_14857.call(null);
if((count_14856 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14858 = (count_14856 + (1));
count_14856 = G__14858;
continue;
}
} else
{}
