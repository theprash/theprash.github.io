...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18321 = 0;while(true){
var m_18322 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18322 == null))
{} else
{m_18322.call(null);
if((count_18321 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18323 = (count_18321 + 1);
count_18321 = G__18323;
continue;
}
} else
{}
